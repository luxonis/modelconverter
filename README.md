...
The `output_dir` can be specified using the `--output-dir` CLI argument. If such
a directory already exists, it is overwritten. If not specified, it is
autogenerated in the format `<model_name>_to_<target>_<date>_<time>`.
