...
Requires `snpe-<version>.zip` archive to be present in `docker/extra_packages`. You can download version `2.33.0` from [here](https://softwarecenter.qualcomm.com/api/download/software/sdks/Qualcomm_AI_Runtime_Community/All/2.33.0.250327/v2.33.0.250327.zip). You only need to rename it to `snpe-2.33.0.zip` and place it in the `docker/extra_packages` directory.
