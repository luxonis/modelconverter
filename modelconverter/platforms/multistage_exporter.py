...
exporter of the selected platform, running the earlier stage's model
with that platform's inferer whenever such a link has to be resolved.
"""
...
class MultiStageExporter:
    ...
    each by the exporter of the given platform. Before a stage runs, any
    ...
    def __init__(
        ...
        Args:
            platform: Platform the stages are converted for.
