...
class TestFromOnnxDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), ONNX_CASES)
    def test_supported(self, dtype: int, expected: DataType):
...
class TestFromNumpyDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), NUMPY_CASES)
    def test_supported(self, dtype: type, expected: DataType):
...
class TestFromIrIeDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), IR_IE_CASES)
    def test_supported(self, dtype: str, expected: DataType):
...
class TestFromIrRuntimeDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), IR_RT_CASES)
    def test_supported(self, dtype: str, expected: DataType):
...
class TestFromDlcDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), DLC_CASES)
    def test_supported(self, dtype: str, expected: DataType):
...
class TestFromHubaiDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), HUBAI_CASES)
    def test_supported(self, dtype: str, expected: DataType):
...
class TestFromDaiDtype:
    ...
    @pytest.mark.parametrize(("member", "expected"), DAI_CASES)
    def test_supported(self, member: str, expected: DataType):
...
class TestFromTensorflowDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), TF_CASES)
    def test_supported(self, dtype: int, expected: DataType):
...
class TestAsDaiDtype:
    ...
    @pytest.mark.parametrize("dtype", SUPPORTED)
    def test_supported(self, dtype: DataType):
        import depthai as dai
...
class TestAsNumpyDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), NUMPY_CASES)
    def test_all(self, dtype: DataType, expected: type):
        assert dtype.as_numpy_dtype() is expected


class TestAsOpenvinoDtype:
    OPENVINO_CASES = [
    ...
    @pytest.mark.parametrize(("dtype", "expected"), OPENVINO_CASES)
    def test_supported(self, dtype: DataType, expected: str):
...
class TestAsNnArchiveDtype:
    ...
    @pytest.mark.parametrize(("dtype", "expected"), NN_ARCHIVE_CASES)
    def test_all(self, dtype: DataType, expected: str):
        assert dtype.as_nn_archive_dtype() == expected


class TestInputFileTypeFromPath:
    PATH_CASES = [
    ...
    def test_supported_str(self, path: str, expected: InputFileType):
        assert InputFileType.from_path(path) is expected

    def test_supported_path_object(self):
        assert (
            InputFileType.from_path(Path("dir/model.onnx"))
            is InputFileType.ONNX
        )
