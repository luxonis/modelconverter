...
def test_mnist_infer(rvc4_mnist_onnx_env, tool_version):
...
def test_resnet18_infer(rvc4_resnet18_onnx_env, tool_version):
...
def test_resnet18_non_quant_infer(
    rvc4_non_quant_resnet18_onnx_env, tool_version
):
...
def test_resnet18_archive_infer(rvc4_resnet18_archive_env, tool_version):
...
def test_yolov6n_infer(rvc4_yolov6n_onnx_env, tool_version):
